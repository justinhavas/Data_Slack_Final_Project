...
/* track number of loads and stores */
static counter_t sim_num_loads_and_stores = 0;
...
sim_reg_stats(struct stat_sdb_t *sdb)
{
  ...
  stat_reg_counter(sdb, "sim_num_refs",
		   ...
		   &sim_num_refs, 0, NULL);
  stat_reg_counter(sdb, "sim_num_loads_and_stores",
		   "Actual total number of loads and stores executed",
		   &sim_num_loads_and_stores, 0, NULL);
